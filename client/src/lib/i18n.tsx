...
const translations = {
  en: {
    ...
    bestHand: 'Best hand',
    clear: 'Clear',
    pickBoardCards: 'Select Board Cards',
    pickHandCards: 'Select Hand Cards',

    authTitle: 'Sign In to Plozilla',
    authLogin: 'Log In',
    authSignup: 'Sign Up',
    authName: 'Name',
    ...
    authGoogle: 'Google',
    authYandex: 'Yandex ID',
    authReplit: 'Replit',
    authSignupSuccess: 'Account created! Check your email to verify.',
    ...
    authVerifySuccess: 'Email verified successfully! You are now logged in.',
    authVerifyInvalid: 'Invalid or expired verification link.',
    authVerifyExpired: 'Verification link has expired. Please request a new one.',
    authVerifyError: 'An error occurred during verification.',
    authVerifying: 'Verifying your email...',
    authGoToApp: 'Go to App',
    ...
    authResetSent: 'If an account exists, a password reset email was sent.',
  ...
  ru: {
    ...
    clear: 'Очистить',
    pickBoardCards: 'Выберите карты борда',
    pickHandCards: 'Выберите карты руки',

    authTitle: 'Войти в Plozilla',
    authLogin: 'Вход',
    ...
    authOrDivider: 'или войти через',
    authGoogle: 'Google',
    authYandex: 'Яндекс ID',
    authReplit: 'Replit',
    authSignupSuccess: 'Аккаунт создан! Проверьте почту для подтверждения.',
    authPasswordMin: 'Пароль должен быть не менее 8 символов',
    authPasswordMismatch: 'Пароли не совпадают',
    authEmailInvalid: 'Некорректный email',
    authVerifyEmail: 'Подтверждение email',
    authVerifySuccess: 'Email подтверждён! Вы уже авторизованы.',
    authVerifyInvalid: 'Недействительная или устаревшая ссылка подтверждения.',
    authVerifyExpired: 'Ссылка подтверждения истекла. Запросите новую.',
    authVerifyError: 'Произошла ошибка при подтверждении.',
    authVerifying: 'Подтверждаем ваш email...',
    authGoToApp: 'Перейти в приложение',
    authResendVerification: 'Отправить повторно',
    authEmailNotVerified: 'Подтвердите email перед входом.',
    authResetPassword: 'Сброс пароля',
    authNewPassword: 'Новый пароль',
    authResetButton: 'Сбросить пароль',
    authResetSuccess: 'Пароль сброшен. Теперь можете войти.',
    authResetSent: 'Если аккаунт существует, письмо для сброса отправлено.',
    ...
    engineRemote: 'Движок: VPS',
    engineLocal: 'Движок: Локальный',
    engineTime: 'Движок',
