...
const translations = {
  en: {
    ...
    rankingsTitle: 'PLO5 Starting Hand Rankings',
    rankingsDesc: '2,598,960 possible 5-card hands grouped into {n} rank groups by card ranks and suit structure (DS/SS).',
    rankingsRank: '#',
    rankingsHand: 'Hand group',
    rankingsType: 'Type',
    rankingsCombos: 'Combos',
    rankingsPercentile: 'Rank%',
    rankingsNote: 'Ranked by equity vs random hand (Monte Carlo). Each group combines all suit variations of the same ranks. DS = double-suited, SS = single-suited.',
    rankingsEquity: 'EQ%',
    rankingsTotal: 'Hand groups',
    rankingsShowing: 'Showing',
    rankingsPerPage: 'Per page',
    rankingsGenerating: 'Generating rankings...',
    rankingsComputing: 'Computing equity vs random hand...',
    rankingsLoadingWasm: 'Loading evaluator...',
    rankingsDS: 'ds',
    rankingsSS: 'ss',
  ...
  ru: {
    ...
    rankingsTitle: 'Рейтинг стартовых рук PLO5',
    rankingsDesc: '2,598,960 возможных 5-карточных рук сгруппированы в {n} групп по рангам карт и структуре мастей (DS/SS).',
    rankingsRank: '#',
    rankingsHand: 'Группа рук',
    rankingsType: 'Тип',
    rankingsCombos: 'Комбо',
    rankingsPercentile: 'Ранг%',
    rankingsNote: 'Ранжирование по эквити против случайной руки (Монте-Карло). Каждая группа объединяет все масти одинаковых рангов. DS = двухмастная, SS = одномастная.',
    rankingsEquity: 'EQ%',
    rankingsTotal: 'Групп рук',
    rankingsShowing: 'Показано',
    rankingsPerPage: 'На странице',
    rankingsGenerating: 'Генерация рейтинга...',
    rankingsComputing: 'Расчёт эквити против случайной руки...',
    rankingsLoadingWasm: 'Загрузка движка...',
    rankingsDS: 'дс',
    rankingsSS: 'сс',
