...
const translations = {
  en: {
    ...
    rankingsDesc: 'All {n} possible 5-card hands ranked by equity vs random hand (Monte Carlo).',
    rankingsRank: '#',
    rankingsHand: 'Hand',
    rankingsType: 'Type',
    rankingsCombos: 'Combos',
    rankingsPercentile: 'Rank%',
    rankingsNote: 'Each hand is ranked individually by equity vs a random opponent hand using Monte Carlo simulation (50 trials per hand).',
    rankingsEquity: 'EQ%',
  ...
  ru: {
    ...
    rankingsDesc: 'Все {n} возможных 5-карточных рук ранжированы по эквити против случайной руки (Монте-Карло).',
    rankingsRank: '#',
    rankingsHand: 'Рука',
    rankingsType: 'Тип',
    rankingsCombos: 'Комбо',
    rankingsPercentile: 'Ранг%',
    rankingsNote: 'Каждая рука ранжирована индивидуально по эквити против случайного оппонента с помощью Монте-Карло симуляции (50 испытаний на руку).',
    rankingsEquity: 'EQ%',
