...
const translations = {
  en: {
    ...
    rankingsDesc: 'All 5-card starting hands ranked from best to worst by preflop strength.',
    rankingsRank: '#',
    rankingsHand: 'Hand group',
    rankingsType: 'Type',
    rankingsCombos: 'Combos',
    rankingsPercentile: 'Rank%',
    rankingsNote: 'Rankings based on card quality, pairs, suitedness and connectivity. DS = double-suited, SS = single-suited. Higher cards, pairs (especially AA/KK) and connected cards rank better.',
    rankingsTotal: 'Distinct hands',
  ...
  ru: {
    ...
    rankingsDesc: 'Все 5-карточные стартовые руки от лучшей к худшей по силе на префлопе.',
    rankingsRank: '#',
    rankingsHand: 'Группа рук',
    rankingsType: 'Тип',
    rankingsCombos: 'Комбо',
    rankingsPercentile: 'Ранг%',
    rankingsNote: 'Рейтинг основан на качестве карт, парах, мастях и связности. DS = двухмастная, SS = одномастная. Высокие карты, пары (особенно AA/KK) и связанные карты ранжируются выше.',
    rankingsTotal: 'Различных рук',
