...
const translations = {
  en: {
    ...
    rankingsNote: 'Each group combines all suit variations of the same ranks. "Combos" = number of specific 5-card hands in that group. DS = double-suited (two pairs of suited cards), SS = single-suited (one pair of suited cards).',
  ...
  ru: {
    ...
    rankingsNote: 'Каждая группа объединяет все масти одинаковых рангов. «Комбо» = кол-во конкретных 5-карточных рук в группе. DS = двухмастная (две пары одномастных карт), SS = одномастная (одна пара одномастных карт).',
