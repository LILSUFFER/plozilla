...
const translations = {
  en: {
    ...
    rankingsDesc: '134,459 canonical hands (suit-isomorphic) ranked by equity vs random opponent. 10,000 Monte Carlo trials per hand.',
    rankingsRank: '#',
    rankingsHand: 'Hand',
    rankingsType: 'Type',
    ...
    rankingsGenerating: 'Computing canonical hand rankings...',
    rankingsCanonicalNote: '134,459 canonical hands with 10,000 MC trials each. Progress is saved — survives restarts.',
  ...
  ru: {
    ...
    rankingsDesc: '134 459 канонических рук (изоморфных по мастям) ранжированы по эквити vs случайный оппонент. 10 000 MC-триалов на руку.',
    rankingsRank: '#',
    rankingsHand: 'Рука',
    rankingsType: 'Тип',
    ...
    rankingsGenerating: 'Расчёт рейтинга канонических рук...',
    rankingsCanonicalNote: '134 459 канонических рук с 10 000 MC-триалами каждая. Прогресс сохраняется — переживает рестарты.',
